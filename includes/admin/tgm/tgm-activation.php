 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Medium
...
add_action( 'tgmpa_register', 'medium_register_required_plugins' );
 ...
 */
function medium_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'medium_wpforms_shareasale_id' );

function medium_wpforms_shareasale_id( $shareasale_id ) {
